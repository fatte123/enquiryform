...
/**
 * requestinfo edit form main tab
 */
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Digital\RequestinfoModel\Requestinfo */
        ...
        $form->setHtmlIdPrefix('requestinfo_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_requestinfo_edit_tab_content_prepare_form', ['form' => $form]);
