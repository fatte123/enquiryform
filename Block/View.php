...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getRequestinfo()->getTitle());
    }
    ...
    {
        return $this->_coreRegistry->registry('current_requestinfo');
    }
    ...
    {
        return $this->getUrl('requestinfo/index/index');
    }
